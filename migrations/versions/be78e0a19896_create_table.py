...
Revision ID: be78e0a19896
Revises: 
Create Date: 2020-08-01 01:29:45.915175
...
def upgrade():
    ...
    sa.Column('permission', sa.String(length=32), server_default='11000000000000000000000000000000', nullable=True),
